...
Public Class Form1
    ...
    Private PATH_FONTS As String = "C:\Users\Cristhiam\Desktop\Barcode\Fonts"
    ...
    Private Sub btPrint_Click_1(sender As Object, e As EventArgs) Handles btPrint.Click
        ...
        Report1.Load("C:\Users\Cristhiam\Desktop\Informe1.rpt", CrystalDecisions.Shared.OpenReportMethod.OpenReportByDefault.OpenReportByDefault)
    ...
    Protected WithEvents cRpt As New CrystalDecisions.CrystalReports.Engine.ReportDocument()
    ...
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        pfc.AddFontFile(PATH_FONTS & "\EAN-13.TTF")
